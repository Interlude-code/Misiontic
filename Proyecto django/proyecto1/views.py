...
def saludo(request): #primera vista
    ...
    return render(request,'plantillaPagina.html',{'nombrePersona':nombre,'dia':ahora,'gatos':lista1}) #hace todo simplificado el request es obligatorio ,el siguiente es
