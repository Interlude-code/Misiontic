...
def saludo(request): #primera vista
    nombre='Juan Carlos Cabrera Pinto'
    ...
    ctx= Context({'nombrePersona':nombre,'dia':ahora})#se crea el objeto Context si hay dinamicidad en la pagina recibe diccionarios y objetos como entrada
